...
ActiveRecord::Schema.define(version: 20140721063617) do
  ...
  create_table "author_articles", force: true do |t|
    t.integer  "author_id"
  ...
  add_index "author_articles", ["article_id"], name: "index_author_articles_on_article_id", using: :btree
  add_index "author_articles", ["author_id"], name: "index_author_articles_on_author_id", using: :btree
  ...
  add_index "journal_translations", ["locale"], name: "index_journal_translations_on_locale", using: :btree
